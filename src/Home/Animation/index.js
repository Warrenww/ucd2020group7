    ...
    <div className={classes.videoCanvas}>
        <Wrapper playState={PlayState.stop}>
          ...
          >
            ...
            <RetangleBackground color="#F0EEB8" width={titleWidth} height={titleHeight} duration={titleDuration} position={0.2}/>
            <RetangleBackground color="#E1E7DC" width={titleWidth} height={titleHeight} duration={titleDuration} position={0.3}/>
            <RetangleBackground color="#93B7B4" width={titleWidth} height={titleHeight} duration={titleDuration} position={0.5}/>
